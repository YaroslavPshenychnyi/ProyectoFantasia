...
public class Dialogo {
	...
	public static void main(String[] args) {
		...
		int contSergio, contMaria, contLucia, contYaroslav;
		contSergio = contMaria = contLucia = contYaroslav = 0;
		...
		System.out.println(
				"Nuestra historia comienza con el silbido del viento y la tétrica sinfonía de un bosque durante la noche.\n"
						...
						+ "intensa de un veterano de guerra; aunque el rasgo que mas me llama la atención son sus ojos, cuya tonalidad cambia segun el angulo por el que los miras\n"
						...
						+ "En ese momento, me doy cuenta que la extraña criatura está hablando para sí misma y, interesado por sus palabras, me concentro en escuchar su mónologo: \n");
		contSergio++;
		
		System.out.println();
		System.out.println("	-¡Que gran día para pescar! -dijo el hada alegre- ...Si no fuese por las normas del general ahora mismo me estaría divirtiendo mucho más -dijo, \n"
				+ "esta vez con un tono más sombrío-. ¡Sólo lo aguanto mientras aclaro el malentendido con el rey! Y pensar que un día me temían todos... -¡sorprendente! \n"
				+ "El hada ha cambiado de forma, ¡otra vez! Su rigida mandíbula se suaviza, mostrando un rostro más redondo, su cuerpo ligeramente musculado y calloso \n"
				+ "parece perder su textura, y su mirada, antes penetrante y aterradora, ahora parece asimilarse más a la de un niño-. ¡Y así será! -la forma infantil \n"
		...
		System.out.println("<<Una historia maravillosa, un hada desterrada y un plan de venganza, que ser mas interesante ha llegado a mi bosque. Una lástima que rezume maldad>>\n"
				+ "Escucho cómo la criatura suelta varias maldiciones contra ese tal general durante un buen rato hasta que algo más llama mi atención.\n"
				+ "Por uno de los caminos que llega a la encrucijada veo llegar a una humana normal aunque su indumentaria está claramente fuera de lugar pues en lugar \n"
				+ "de los jubones y calzones propios de los mortales mas comúnes, esta viste unos vaqueros destrozados y una blusa quemada, ropas propias de ese mundo \n"
				+ "triste llamado Tierra.\n"
		...
		System.out.println();
		System.out.println("     -Tsk, maldito palo... menudo bastón me he ido a buscar, aunque bueno, el camino tampoco es que ayude mucho. Aaah. Bueno eso y el haber \n"
				+ "sufrido un accidente, haberme despertado en a saber dónde y el haber perdido todas mis pertenencias, y eso que he buscado lo mejor que he podido con \n"
				+ "esta pierna maltrecha... ¿Eso que eschucho es agua? Agua y algo más, ¿alguien está cantando? Esto no me gusta... - la joven paró en seco - ¿Quién hay \n"
				+ "ahí? - dijo lo más alto que le permitió su raspada voz");
		contMaria++;
		...
		System.out.println();
		System.out.println("	-Jajajajaj -¡que inesperada reacción! ¿El hada está riendose? ¿Peligra su vida y su reacción es reirse a carcajadas?-. ¡¿Cómo osas \n"
		...
		System.out.println("Lucia: " + contLucia);
	}
